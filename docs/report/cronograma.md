...
**Lo que no se ejecutó.** La tarea 13, optimización de carga de cómputo en configuraciones heterogéneas, con 150 horas estimadas, **no se abordó**: dependía de disponer de máquinas físicas con capacidades distintas, algo que el entorno de simulación sobre una única máquina no permite representar de forma convincente. La tolerancia a fallos, que la propuesta no listaba como tarea numerada pero que era parte del alcance declarado, se intentó tres veces sin éxito y finalmente se retrajo, según se detalla en *Riesgos materializados y lecciones aprendidas*.

**Lo que se ejecutó sin estar planificado.** Aparecieron cuatro líneas no previstas. La **selección de topología** mediante estadísticas de latencia y resolución del ordenamiento del anillo como un problema del viajante. La **auditoría de corrección distribuida** que surgió de la construcción de la suite de benchmarks y que destapó tres errores silenciosos de fondo. La **optimización del motor de convolución** mediante reformulación como multiplicación de matrices. Y las **dos monografías** que constituyen los estudios experimentales de este informe, que excedieron en profundidad lo que la tarea 14 contemplaba.

**Una observación sobre la estimación.** La distribución de horas de la propuesta asignaba 200 horas a investigar las implementaciones distribuidas de TensorFlow y PyTorch (tareas 2 y 3). En la práctica, ese estudio se realizó pero de forma mucho más acotada y en modalidad de consulta puntual, y el esfuerzo se redistribuyó hacia la implementación y la depuración del motor de aprendizaje. La lección de estimación es la habitual y no por conocida menos real: **el esfuerzo se subestima sistemáticamente en aquello que no se conoce de antemano**, que en este trabajo fue todo lo relativo a la corrección numérica del entrenamiento y a la coordinación distribuida.
