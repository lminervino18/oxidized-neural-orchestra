...
El estudio experimental fue desarrollado originalmente como una de las dos monografías individuales que dos de los integrantes del equipo desarrollaron en el marco de la materia Aprendizaje Profundo, sobre un arnés de experimentación propio que no forma parte de este repositorio. Sus configuraciones, sus resultados y el criterio de comparación de cada uno se documentan en *Experimentación y validación*, y las monografías completas se ponen a disposición como documentos separados.
