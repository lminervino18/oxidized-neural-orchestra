...
Luego de haber leído el informe del Trabajo Profesional "Oxidized Neural Orchestra", el Director del mismo, Ing. Ricardo Alfredo Veiga, declara que el mismo se corresponde con el trabajo realizado a lo largo del proyecto y avala el documento presentado como Informe Final, tanto en su completitud como en la claridad de redacción.

\vspace{1.5cm}

\noindent\textbf{Firma y aclaración del director:}

\vspace{.6cm}

\begin{tabular}{@{}l l@{}}
\textbf{Ing. Ricardo Alfredo Veiga} & \underline{\hspace{7cm}}
\end{tabular}

\vspace{1.5cm}

\noindent\textbf{Firmas y aclaraciones de los estudiantes:}
