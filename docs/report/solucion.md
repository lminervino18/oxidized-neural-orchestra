...
5. **Estrategias de Sincronización y Distribución:** Soporta tres esquemas de distribución integrados:
  ...
  * **Strategy-Switch:** Conmutación dinámica de All-Reduce a Parameter Server asincrónico cuando la pérdida se estabiliza. Sobre una ventana de las últimas *N* pérdidas registradas se promedia la variación relativa entre pérdidas consecutivas, y el cambio de estrategia se dispara apenas ese promedio cae por debajo de un umbral fijo, siguiendo el criterio de Provatas et al. [@provatas2025strategyswitch].
